...
import org.example.dto.DicDistrict;
...
public class MapDIstrictClient {
    ...
    public   ResponseResult initDicDistrict(){
        ...
        url.append("https://restapi.amap.com/v3/config/district?keywords=中国&subdistrict=3&key=69d7396ecfe71d97d68624b25266d2ad");
        RestTemplate restTemplate = new RestTemplate();
        ResponseEntity<String> forEntity = restTemplate.getForEntity(url.toString(), String.class);
        // 解析结果
        JSONObject body = JSONObject.fromObject(forEntity);
        JSONObject dicDistrictJsonObject = body.getJSONObject("body");
